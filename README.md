...
LightRAG now supports **Semantic Chunking** using BGE Chinese embedding models, providing more intelligent text segmentation compared to traditional token-based chunking. This enhancement ensures better semantic coherence and context preservation in document processing.

**Semantic Chunking Features:**
- **Semantic-Aware Segmentation**: Chunks text based on semantic similarity rather than simple token counts
- **Context Preservation**: Maintains sentence and paragraph semantic integrity
- **Intelligent Boundaries**: Identifies optimal split points based on content meaning
- **Chinese-Optimized**: Specifically designed for Chinese text processing
